...
def fetch_merchant_data():
    ...
    if response.status_code == 200:
        ...
        print(
            f"Failed to retrieve merchant data. Status code: {response.status_code}")
        return []
...
def fetch_area_data():
    ...
    if response_areas.status_code == 200:
        ...
        print(
            f"Failed to retrieve area data. Status code: {response_areas.status_code}")
        return []
...
def create_heatmap_with_areas():
    ...
    if merchant_info:
        ...
        heatmap_output = os.path.join(
            script_directory,
            'merchant_heatmap_with_community_areas.html')
