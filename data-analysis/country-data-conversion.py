...
def extract_elements(feature):
    ...
    extracted_feature = {
        ...
        "tags": {
            ...
            "formal_en": feature["properties"].get("formal_en", ""),
            ...
            "pop_est": feature["properties"].get("pop_est", ""),
            "pop_rank": feature["properties"].get("pop_rank", ""),
            "pop_year": feature["properties"].get("pop_year", ""),
